...
var vegetables = ["Carrots", "Parsnips", "Celery", "Potatoes", "Garlic"];
...
var fruits = ["Strawberry", "Banana", "Pineapple", "Coconut", "Lychee", "Guava", "Pomegranate"];
...
var groceryStore = {
    ...
    isOpen: true,
    hours: "6am - 11pm",
    departments: ["Pharmacy", "Money Services"],
    hasStarbucks: true,
};
